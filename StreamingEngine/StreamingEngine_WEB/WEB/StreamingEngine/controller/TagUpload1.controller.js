...
sap.ui.define([
    ...
    return BaseController.extend("StreamingEngine.StreamingEngine.controller.TagUpload1", {
        formatter: formatter,
        onInit: function () {
    ...
    MessageBox.confirm(
        "The default destination for the plant " + splantFile + " is: " + sDefaultDestination ,
        {
